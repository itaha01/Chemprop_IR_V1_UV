...
def add_train_args(parser: ArgumentParser):
    ...
    parser.add_argument('--checkpoint_path', type=str, default=None,
                        help='Path to model checkpoint (.pt file)')
    parser.add_argument('--dataset_type', type=str, default='spectra',
    ...
    parser.add_argument('--metric', type=str, default='srmse',
    ...
    ##ADDED NO_CACHE_IR
    parser.add_argument('--no_cache_ir', action='store_true', default=False, help='Whether to disable caching in IR featurization')
    ...
    parser.add_argument('--final_lr', type=float, default=6.5e-5,
